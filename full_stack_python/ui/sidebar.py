...
def sidebar_user_item() -> rx.Component:
    ...
    username_via_user_obj = rx.cond(
        ...
        SessionState.authenticated_username, "Account"
        )
    return rx.cond(
        user_info_obj,
        rx.hstack(
...
def sidebar_items() -> rx.Component:
    return rx.vstack(
        ...
        sidebar_item("Contact", "contact-round", navigation.routes.CONTACT_US_ROUTE),
        sidebar_item("Contact History", "notebook-tabs", navigation.routes.CONTACT_ENTRIES_ROUTE),
        spacing="1",
        width="100%",
    )
